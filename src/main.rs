...
fn main() {
    ...
    let test_cases = vec![(5.0, 200.0, 4.8), (50.0, 3000.0, 2.1), (15.0, 800.0, 3.5)];
    ...
    println!("\nBatch predictions:");
    let batch_inputs = vec![(10.0, 500.0, 4.5), (25.0, 1500.0, 3.0), (40.0, 2500.0, 1.5)];
    ...
    for (i, (((distance, price, rating), prob), accepted)) in batch_inputs
        .iter()
